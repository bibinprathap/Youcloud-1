                    ...
                    <div className="form_border_1">
                        ...
                        <form>
                            ...
                            <div className="form-group">
                                ...
                                <input type="email" id="Email" name="email" placeholder="Enter your email" onChange={this.handleChange}></input>
                            ...
                            <div>
                                ...
                                <input type="tel" id="phone" name="phone" placeholder="+971"></input>
                            </div><br />
                            <div>
